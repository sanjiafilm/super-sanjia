...
public class GradeMovieController {
    ...
    @RequestMapping("/all")
    @ResponseBody
    public PageInfo<Movie> getIndex(Double lng, Double lat, Integer page) {
        return gradeService.getAll(page, lng, lat);
    }
    ...
    @RequestMapping("/buy")
    @ResponseBody
    public PageInfo<Purchase> findPurchase(String name, Double lng, Double lat, Integer page) {
        return gradeService.findPurchaseInfo(name, lat, lng, page);
    }
